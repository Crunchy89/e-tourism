...
type mockConstructorTestingTNewPenginapanRepository interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewPenginapanRepository(t mockConstructorTestingTNewPenginapanRepository) *PenginapanRepository {
