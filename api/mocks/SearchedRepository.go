...
type mockConstructorTestingTNewSearchedRepository interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewSearchedRepository(t mockConstructorTestingTNewSearchedRepository) *SearchedRepository {
